...
import sudoku.cobyapps.com.sudoku.dlx.data.DataObject;
import sudoku.cobyapps.com.sudoku.dlx.data.DebugDataObject;
...
public class DLX {
	 ...
	 */
	public final ColumnObject buildSparseMatrix(byte[][] input) {
	 ...
	 */
	public final void solve(ColumnObject h, boolean useSHeuristic) {
	...
	public static final void setColumnsAsOptional(ColumnObject h, 
	 ...
	 final boolean solve(ColumnObject h, boolean useSHeuristic,
